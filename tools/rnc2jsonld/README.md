...
`Tag` nodes identify individual schema fields (e.g. a liability cap, an
effective date, a vendor name). `TagGroup` nodes define named sets of tags
that appear together in a given structural role.
